...
export const PersistanceKeys = {
  ...
  addCalendarScope:
    'openid email profile https://www.googleapis.com/auth/calendar https://www.googleapis.com/auth/calendar.settings.readonly',
...
export const privacyPollicyUrl = 'https://www.assignx.ai/privacy-policy'
export const CancellationAndRefundUrl =
  'https://www.assignx.ai/cancellation-return-policy' //"https://www.google.com/url?q=https://www.myagentx.com/cancellation-return-policy&sa=D&source=docs&ust=1751402335347404&usg=AOvVaw2aDueiwwhLkomUAiT_eTPT";
...
export const agencyCancellationAndRefundUrl =
  'https://www.assignx.ai/agency-refunds'
...
/** Rotating status lines while the web agent chat is waiting for a reply (WebAgentChatDrawer). */
export const WEB_AGENT_THINKING_MESSAGES = [
  'Thinking…',
  ...
  'Shaping your answer…',
  'Creating something tailored for you…',
  ...
  'Just a moment…',
  'One sec, working on this…',
  'Let me think…',
  'Give me a second…',
  'Working on it…',
  'Almost there…',
  'Orchestrating response…',
  'Activating reasoning layer…',
  'Synthesizing insights…',
  'Aligning context…',
  'Mapping intent…',
  'Building optimal response path…',
  'Running cognitive pass…',
  'Finalizing output…',
]
