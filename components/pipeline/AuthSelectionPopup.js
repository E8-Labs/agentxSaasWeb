import { Box, Modal, CircularProgress, FormControl, Select, MenuItem } from '@mui/material'
import React, { useCallback, useEffect, useState } from 'react'
import CloseBtn from '../globalExtras/CloseBtn'
import Image from 'next/image'
import { Scopes } from '../dashboard/myagentX/Scopes'
import AgentSelectSnackMessage, { SnackbarTypes } from '../dashboard/leads/AgentSelectSnackMessage'
import { connectGmailAccount, deleteAccount, getGmailAccounts } from './TempleteServices'
...

                    {
                        loginLoader ? (
                            ...
                            <div className='flex flex-col gap-6 w-full items-center mt-7'>
                                <button onClick={handleGoogleOAuthClick}
                                    className='disabled:opacity-60'>
                                    <Image src={'/otherAssets/gmailIcon.png'}
