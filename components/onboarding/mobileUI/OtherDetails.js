...
const OtherDetails = ({ handleContinue, handleBack, length = 6, onComplete, userDetails }) => {
    ...
    useEffect(() => {
        ...
        if (userData?.userTypeTitle === "Sales Dev Rep" || userData?.userTypeTitle === "Marketer") {
            if (
                service && companyName
            ) {
        ...
        } else if (userData?.userTypeTitle === "Recuiter Agent" || userData?.userTypeTitle === "Tax Agent") {
            if (websiteUrservice) {
                setShouldContinue(false);
            } else if (!service) {
                setShouldContinue(true);
                    ...
                    <div className="flex flex-col items-center px-4 w-full h-[90%]">
                        ...
                        >
...

                            {
                                ...
                                //     "RealEstateAgent") :
                                userData?.userTypeTitle === "Sales Dev Rep" || userData?.userTypeTitle === "Marketer" ?
                                    (
                                    ...
                                    userData?.userTypeTitle === "Solar Rep" ?
                                        ...
                                        userData?.userTypeTitle === "Insurance Agent" ?
                                            ...
                                            userData?.userTypeTitle === "Website Owners" ?
                                                ...
                                                userData?.userTypeTitle === "Recuiter Agent" || userData?.userTypeTitle === "Tax Agent" ?
                                                    (
                                                        <div className="w-full">
                                                            <div style={styles.headingStyle} className="mt-6">
                                                                Where do you primarily operate or serve customers
