...
const FocusArea = ({
    ...
    return (
        <div style={{ width: "100%" }} className="overflow-y-hidden flex flex-row justify-center items-center">
            <div className='bg-white sm:rounded-2xl flex flex-col justify-between w-full sm:mx-2 md:w-10/12 sm:h-[90%] py-4 ' style={{ scrollbarWidth: "none" }}//overflow-auto scrollbar scrollbar-track-transparent scrollbar-thin scrollbar-thumb-purple
            >
                                                        ...
                                                        <div className='text-start w-[100%] md:w-[90%]'>
                                                            ...
                                                            <div className='mt-2'>
                                                                <input
                                                                    ...
                                                                    style={{ fontFamily: "", fontWeight: "500", fontSize: 15, color: "#151515", border: "0px solid black" }}
