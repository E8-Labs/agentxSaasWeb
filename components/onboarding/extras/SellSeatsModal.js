...
const SellSeatsModal = ({ showModal, closeModal, seats }) => {
  ...
  return (
    ...
    >
      ...
      <Box className="bg-white rounded-xl p-6 max-w-md w-[95%] max-h-[90vh] border-none shadow-lg absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col">
        <div className="w-full">
          <div className="flex flex-row items-center justify-between w-full">
            <div style={styles.heading}>Sell Seats</div>
            <button
              onClick={() => {
                handleClose()
              }}
            >
              <Image src={'/assets/cross.png'} alt="*" height={13} width={13} />
            </button>
          </div>
