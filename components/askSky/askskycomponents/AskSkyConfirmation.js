...
function AskSkyConfirmation({
    ...
    const handleAfterGoogleLogin = (data) => {
        try {
            ...
            console.log("🔁 Refresh Token:", data.refresh_token || "No refresh token received");
            ...
            >
                <div className="flex flex-col w-full items-center bg-white rounded-lg">
                    ...
                    <div className="flex flex-row items-center justify-between w-full">
                        <button onClick={handleChatClick} className="px-4 py-2 text-purple border w-5/12 rounded">
                            {optionA}
                        </button>

                        {
                            calenderLoader ? (
                                ...
                                <button onClick={handleCallClick} className="px-4 py-2 bg-purple w-5/12 text-white rounded">
                                    {optionB}
                                </button>
                            )
                        }
