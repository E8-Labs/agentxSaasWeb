...
const DashboardSlider = ({
  ...
  // Brand color state
  const [brandPrimaryColor, setBrandPrimaryColor] = useState(null);
                            ...
                            >
                              ...
                              >
                                ...
                                <Image className=""
                                  ...
                                  alt="*"
                                  style={{
                                    filter: brandPrimaryColor ? getBrandColorFilter() : undefined,
                                ...
                                <div
                                  ...
                                  style={{ 
                                    fontSize: 15, 
                                    fontWeight: "500",
                                    color: index === hoverIndex && brandPrimaryColor 
                                      ? getBrandColorValue() 
                                      : index === hoverIndex 
                                      ? '#7902DF' 
                                      : '#000000',
