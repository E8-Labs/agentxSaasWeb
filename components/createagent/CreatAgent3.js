    ...
    >
      <div className="bg-white sm:rounded-2xl w-full lg:w-10/12 h-[90vh] py-4 bg-red">
        <div className="flex flex-col h-[100%]  ">
          ...
          {selectedPlan && (
            <div className="flex flex-col gap-2 absolute left-1/2 transform -translate-x-1/2 right-2 bottom-[2%] bg-white/30 backdrop-blur-lg w-full md:w-10/12 lg:w-5/12">
