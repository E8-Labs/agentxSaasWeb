...
function PipelineLoading() {
    return (
        <div className='w-full h-full flex flex-col items-start justify-start p-5'>
            <Box sx={{ width: "100%" }}>
                <Skeleton variant="text" width="40%" height={70} sx={{ marginTop: 0 }} />

                <Box sx={{
                    flexDirection: 'row', gap: 3, display: 'flex', marginTop: 4
                }}>
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Skeleton variant="text" width={250} height={250}  sx={{marginTop:-10}}/>
                        <Skeleton variant="text" width={250} height={250} sx={{marginTop:-10}} />
                    </Box>
