import { Alert, Box, CircularProgress, Fade, FormControl, InputLabel, MenuItem, Modal, Popover, Select, Snackbar, TextareaAutosize, Typography } from '@mui/material';
import { CaretDown, CaretUp, DotsThree, EnvelopeSimple, Plus, X } from '@phosphor-icons/react'
                            ...
                            >
                                <div className='p-3'>
                                    ...
                                    <div className='w-full flex flex-row mt-4'>
                                        ...
                                        >
                                            <Image src={"/assets/list.png"} height={18} width={15} alt='*' />
                                            Rearrange Stage
                                        </button>
                                    </div>
                                    {
