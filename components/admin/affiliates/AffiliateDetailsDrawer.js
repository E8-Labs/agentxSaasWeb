      ...
      >
        <div className="w-full flex flex-row items-start justify-between mt-4">
          <div className="flex flex-col items-start gap-2">
            ...
            <div
              style={{ fontSize: 15, fontWeight: '500', color: '#15151580' }}
            >
              {affiliate.email}
            </div>
            <div
          ...
          <div style={{ fontSize: 15, fontWeight: '500', color: '#000' }}>
            Created on{' '}
            {affiliate.createdAt
              ? moment(affiliate.createdAt).format('MMMM DD YYYY hh:mma')
              : '-'}
          </div>
        </div>
        ...
        <div className="flex w-full flex-row justify-between items-center mt-4">
          ...
          <div className="flex flex-col items-start gap-2 bg-[#15151506] rounded-lg h-[77px] w-[170px] p-2">
            ...
            <div style={{ fontSize: 18, fontWeight: '700', color: '#000' }}>
              {affiliate.xbarTotalRevenue?.totalSpent
                ? `$${affiliate.xbarTotalRevenue?.totalSpent.toFixed(2)}`
                : '-'}
            </div>
          </div>
          <div className="flex flex-col items-start gap-2 bg-[#15151506] rounded-lg h-[77px] w-[170px] p-2">
            ...
            <div
              style={{ fontSize: 14, fontWeight: '500', color: '#00000060' }}
            >
              {affiliate.topSpender?.User?.name}{' '}
              <span
        ...
        <div className="flex w-full flex-row justify-between items-center mt-4">
          ...
          <button
            className="text-white bg-purple outline-none rounded-lg px-3 py-2 w-[117] mt-8"
            onClick={() => {
              setShowAddNewPayoutPopup(true)
            }}
          >
            New Payout
          </button>
        ...
        {loading2 ? (
          ...
          <>
            ...
            {payouts.map((item, index) => (
              <div
                key={index}
                className="flex w-full flex-row h-[52px justify-between items-center"
              >
                <div className="w-5/12 flex flex-col justify-center p-3 border-r-2 h-full border-[#15151510] ">
          ...
          <div style={{ fontSize: 16, fontWeight: '500' }}>No payouts</div>
        )}
      </div>
      ...
      >
        ...
        >
          ...
          {loading ? (
            ...
            <button
              className="text-white bg-purple outline-none rounded-lg px-3 py-2 w-[175px] mt-8"
              onClick={() => {
                addPayout(amount)
              }}
            >
