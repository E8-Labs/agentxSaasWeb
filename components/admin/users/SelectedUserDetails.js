      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        >
          ...
          <div className="flex flex-row items-start w-full">
            ...
            <div
              className={`flex flex-col items-center justify-center pt-2 px-4 ${
                from === "admin" || from === "subaccount"
                  ? "h-[70vh]"
                  : "h-[95vh]"
              } overflow-auto w-10/12`}
            >
              {selectedManu.name == "Leads" ? (
                ...
                <AdminAgentX selectedUser={selectedUser} from={from} />
