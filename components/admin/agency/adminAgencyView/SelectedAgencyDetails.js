  ...
  const manuBar = [
    {
      id: 1,
      name: 'Dashboard',
      selectedImage: '/agencyNavbarIcons/selectdDashboardIcon.png',
      unSelectedImage: '/agencyNavbarIcons/unSelectedDashboardIcon.png',
    },
    {
      id: 2,
      name: 'Integrations',
      selectedImage: '/agencyNavbarIcons/integrationFocus.png',
      unSelectedImage: '/agencyNavbarIcons/integrationsUnFocus.png',
    },
    {
      id: 3,
      name: 'Plans',
      selectedImage: '/agencyNavbarIcons/selectedPlansIcon.png',
      unSelectedImage: '/agencyNavbarIcons/unSelectedPlansIcon.png',
    },
    {
      id: 4,
      name: 'Sub Account',
      selectedImage: '/agencyNavbarIcons/selectedSubAccountIcon.png',
      unSelectedImage: '/agencyNavbarIcons/unSelectedSubAccountIcon.png',
    },
    {
      id: 5,
      name: 'Activity',
    ...
    },
    {
      id: 6,
      name: 'Teams',
      selectedImage: '/agencyNavbarIcons/selectedTeam.png',
      unSelectedImage: '/agencyNavbarIcons/unSelectedTeamIcon.png',
    },
      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        >
          ...
          <div className="flex flex-row items-start w-full">
            ...
            <div
              className={`flex flex-col items-start justify-start px-4 pt-12 ${agencyUser ? 'h-[95vh]' : 'h-[70vh]'} overflow-auto w-10/12`}
            >
