  ...
  const getTransactions = async (resetData = false) => {
    try {
      ...
      if (filters.startDate) {
        params.set(
          'startDate',
          moment(filters.startDate, 'MM/DD/YYYY').format('YYYY-MM-DD'),
        )
      }
      if (filters.endDate) {
        params.set(
          'endDate',
          moment(filters.endDate, 'MM/DD/YYYY').format('YYYY-MM-DD'),
        )
      }
  ...
  return (
    <div className="w-full items-start">
      ...
      <div className="w-full flex flex-row mt-3 px-10 bg-gray-50 py-3">
        <div className="w-[15%]">
          <div style={styles.header}>Agency Name</div>
        </div>
        <div className="w-[15%]">
          <div style={styles.header}>Subaccount Name</div>
        </div>
        <div className="w-[8%]">
          <div style={styles.header}>Amount</div>
        </div>
        <div className="w-[15%]">
          <div style={styles.header}>Product</div>
        </div>
        <div className="w-[7%]">
          <div style={styles.header}>Type</div>
        </div>
        <div className="w-[7%]">
          <div style={styles.header}>Stripe Fee</div>
        </div>
        <div className="w-[7%]">
          <div style={styles.header}>Collected</div>
        </div>
        <div className="w-[8%]">
          <div style={styles.header}>Payout</div>
        </div>
        ...
        {transactions.length > 0
          ? transactions.map((transaction) => (
              ...
              >
                ...
                <div className="w-[7%]">
                  <span
                    className={`px-2 py-1 rounded-full text-xs ${getTypeColor(transaction.type)}`}
                  >
                    {transaction.type}
                  </span>
                </div>
                ...
                <div className="w-[10%]">
                  {transaction.onHold ? (
                    ...
                    <div style={styles.cell} className="text-gray-400">
                      -
                    </div>
                  )}
                </div>
