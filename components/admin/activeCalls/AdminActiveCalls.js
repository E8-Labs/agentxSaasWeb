...
function AdminActiveCalls() {
    ...
    const fetchCallAnalytics = useCallback(async () => {
        try {
            ...
            const response = await axios.get(`${Apis.getCallAnalytics}?${params.toString()}`, {
                headers: {
                ...
                {callAnalytics?.summary && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        <div className="bg-white p-4 rounded-lg shadow border">
                            ...
                            <p className="text-2xl font-bold text-purple">{callAnalytics.summary.totalUsers}</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow border">
                            <h3 className="text-sm font-medium text-gray-500">Total Calls</h3>
                            <p className="text-2xl font-bold text-purple">{callAnalytics.summary.totalCalls.toLocaleString()}</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow border">
                            <h3 className="text-sm font-medium text-gray-500">Total Minutes</h3>
                            <p className="text-2xl font-bold text-purple">{callAnalytics.summary.totalMinutesUsed}</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow border">
                            <h3 className="text-sm font-medium text-gray-500">Unique Leads</h3>
                            <p className="text-2xl font-bold text-purple">{callAnalytics.summary.uniqueLeadsCalled}</p>
                        </div>
                    </div>
                )}
            </div>
                ...
                <Paper className="w-full ">
                    <TableContainer className="">
                        <Table stickyHeader>
                            <TableHead>
                                <TableRow>
                                    <TableCell className="bg-gray-50 font-semibold">User Name</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Email</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Role</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Total Calls</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Total Minutes</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Unique Leads</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Hot Leads</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Booked Leads</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Success Rate</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Balance Minutes</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Avg Call Duration</TableCell>
                                    <TableCell className="bg-gray-50 font-semibold">Leads Per Call</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
