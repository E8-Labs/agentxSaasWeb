...
function AdminEngagments() {
  ...
  const progressData = [
    ...
    {
      name: '5Cohort Retention Rate',
      value:
        engagmentData?.cohortRetention?.length > 0
          ? engagmentData?.cohortRetention[0].retentionRate
          : 0,
    },
    { name: 'Cohort Implementation Request', value: 0 },
    {
      name: 'Stickiness Ratio (DAU/MAU)',
      value: engagmentData?.stickinessRatio?.stickinessRatio,
    },
  ]
      ...
      <div className="w-11/12">
          ...
          <div className="flex flex-row items-center gap-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  <p>
                    {selectedDateRange ? selectedDateRange : 'Select Range'}
                  </p>
                  <Image
        ...
        <div className="w-full flex flex-row items-center gap-2 mt-4">
            ...
            <div className="flex flex-row items-center justify-between w-full">
              <div className="flex flex-col justify-between h-[150px]">
                ...
                <div style={{ fontSize: 30, fontWeight: '300' }}>
                  {
                    engagmentData?.usersWithAgentsPercentage
                      ?.usersWithAgentsCount
                  }
                  %
                </div>
              ...
              <div className="flex flex-col justify-between h-[150px] ">
                ...
                <div style={{ fontSize: 30, fontWeight: '300' }}>
                  {
                    engagmentData?.usersWhoSentCallsPercentage
                      ?.usersWhoSentCallsCount
                  }
                  %
                </div>
                <div style={{ fontSize: 16, fontWeight: '500' }}>
          ...
          <div className="flex flex-col items-start justify-between px-2 py-4 bg-[#ffffff68] border-2 border-white rounded-lg h-[242px] w-[231px]">
            ...
            <div style={{ fontSize: 16, fontWeight: '500' }}>
              {engagmentData?.cohortRetention?.length > 0
                ? engagmentData?.cohortRetention[0].totalUsers
                : 0}
            </div>
          </div>
