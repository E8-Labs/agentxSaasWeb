...
export default function UsersWithLeads({ open, onClose, user, from }) {
  ...
  const fetchUsers = async () => {
    try {
      ...
      if (d) {
        ...
        const response = await axios.get(Apis.getUsersWithLeads, {
          headers: {
