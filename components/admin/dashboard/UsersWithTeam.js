...
export default function UsersWithTeam({ open, onClose, user, from }) {
  ...
  const fetchUsers = async () => {
    try {
      ...
      if (d) {
        ...
        const response = await axios.get(Apis.getUsersWithTeams, {
          headers: {
