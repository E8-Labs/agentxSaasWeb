    ...
    try {
      ...
      if (response.data?.status) {
        toast({
          title: 'Success',
          description:
            response.data.message || 'Cron job restarted successfully',
        })
      ...
      toast({
        title: 'Error',
        description:
          error.response?.data?.message || 'Failed to restart cron job',
        variant: 'destructive',
      })
    } finally {
        ...
        <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
          ...
          <div className="w-full flex flex-row bg-gray-50 py-3 px-4">
            ...
            <div className="w-1/12">
              <div className="text-sm font-semibold text-gray-600">Elapsed</div>
            </div>
            <div className="w-1/4">
              <div className="text-sm font-semibold text-gray-600">
                Description
          ...
          <div className="h-[60vh] overflow-auto">
            {cronJobs.map((job, index) => (
              <div
                key={index}
                className="w-full flex flex-row py-3 px-4 border-b border-gray-100 hover:bg-gray-50"
              >
                ...
                <div className="w-1/6 flex items-center">
                  <div className="text-sm">
                    {formatDateTime(job.lastRunTime)}
                  </div>
                </div>
                <div className="w-1/6 flex items-center">
                  <div className="text-sm">
                    {formatDateTime(job.nextExpectedRun)}
                  </div>
                </div>
                <div className="w-1/12 flex items-center">
                  <div className="text-sm">
                    {job.elapsedTimeMinutes
                      ? `${job.elapsedTimeMinutes} min`
                      : 'N/A'}
                  </div>
                </div>
