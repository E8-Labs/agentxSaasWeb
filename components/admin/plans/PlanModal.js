...
const PlanModal = ({ plan, onClose, planType }) => {
  ...
  useEffect(() => {
    if (plan) {
      ...
      const mappedPlan = {
        ...
        discountedPrice: plan.discountedPrice || plan.price || plan.totalPrice || 0,
  ...
  const addLLM = () => {
    if (newLLM.trim()) {
      handleFeatureChange("supportedLLMs", [...formData.dynamicFeatures.supportedLLMs, newLLM.trim()]);
      setNewLLM("");
    }
  };

  const removeLLM = (index) => {
    const updated = formData.dynamicFeatures.supportedLLMs.filter((_, i) => i !== index);
    handleFeatureChange("supportedLLMs", updated);
  };

  const addIntegrationProvider = () => {
    if (newIntegrationProvider.trim()) {
      handleFeatureChange("integrationProviders", [...formData.dynamicFeatures.integrationProviders, newIntegrationProvider.trim()]);
      setNewIntegrationProvider("");
    }
  };

  const removeIntegrationProvider = (index) => {
    const updated = formData.dynamicFeatures.integrationProviders.filter((_, i) => i !== index);
    handleFeatureChange("integrationProviders", updated);
  };

  const addComingSoonFeature = () => {
    if (newComingSoonFeature.trim()) {
      handleFeatureChange("comingSoonFeatures", [...formData.dynamicFeatures.comingSoonFeatures, newComingSoonFeature.trim()]);
      setNewComingSoonFeature("");
    }
  };

  const removeComingSoonFeature = (index) => {
    const updated = formData.dynamicFeatures.comingSoonFeatures.filter((_, i) => i !== index);
      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-6 border-b">
          <h2 className="text-xl font-semibold">
            {plan ? "Edit Plan" : "Add New Plan"} - {planType === "agency" ? "Agency" : "AgentX"}
          </h2>
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("aiCreditsMinutes", parseInt(e.target.value) || 0)}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("contactsLimit", parseInt(e.target.value) || 0)}
                  />
                </div>
                <div>
              ...
              <div className="flex space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleInputChange("hasTrial", checked)}
                  />
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleFeatureChange("maxAgents", parseInt(e.target.value) || 0)}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleFeatureChange("maxAICredits", parseInt(e.target.value) || 0)}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleFeatureChange("maxTeamSeats", parseInt(e.target.value) || 0)}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleFeatureChange("aiCreditRate", parseFloat(e.target.value) || 0)}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleFeatureChange("profitSharePercent", parseFloat(e.target.value) || 0)}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleFeatureChange("affiliatePercent", parseFloat(e.target.value) || 0)}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleFeatureChange("maxSubAccounts", parseInt(e.target.value) || 0)}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleFeatureChange("maxIntegrations", parseInt(e.target.value) || 0)}
                  />
                </div>
                <div>
                  <Label htmlFor="automatedPayoutDays">Automated Payout Days</Label>
                  <Input
                    id="automatedPayoutDays"
                    type="number"
                    value={formData.dynamicFeatures.automatedPayoutDays}
                    onChange={(e) => handleFeatureChange("automatedPayoutDays", parseInt(e.target.value) || 0)}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {formData.dynamicFeatures.integrationProviders.map((provider, index) => (
                    <Badge key={index} variant="secondary" className="flex items-center gap-1">
                      {provider}
                      <button
                        type="button"
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  />
                  <Button type="button" onClick={addIntegrationProvider} size="sm">
                    <Plus className="w-4 h-4" />
                  </Button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {formData.dynamicFeatures.comingSoonFeatures.map((feature, index) => (
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  />
                  <Button type="button" onClick={addComingSoonFeature} size="sm">
                    <Plus className="w-4 h-4" />
                  </Button>
                </div>
              </div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { key: "allowDiscordSupport", label: "Allow Discord Support" },
                  { key: "allowLeadEnrichment", label: "Allow Lead Enrichment" },
                  { key: "allowTwilioTrustHub", label: "Allow Twilio Trust Hub" },
                  { key: "allowAIPoweredEmails", label: "Allow AI Powered Emails" },
                  { key: "allowPriorityCalling", label: "Allow Priority Calling" },
                  { key: "allowCustomVoicemails", label: "Allow Custom Voicemails" },
                  { key: "allowLiveCallTransfer", label: "Allow Live Call Transfer" },
                  { key: "allowAIPowerediMessage", label: "Allow AI Powered iMessage" },
                  { key: "allowUnlimitedTeamSeats", label: "Allow Unlimited Team Seats" },
                  { key: "allowRAGKnowledgeBase", label: "Allow RAG Knowledge Base" },
                  { key: "allowUnlimitedMinutes", label: "Allow Unlimited Minutes" },
                  { key: "allowCustomClientPlans", label: "Allow Custom Client Plans" },
                  { key: "allowPersonalZoomSupport", label: "Allow Personal Zoom Support" },
                  { key: "allowDedicatedSupportLine", label: "Allow Dedicated Support Line" },
                  { key: "allowUltraPriorityCalling", label: "Allow Ultra Priority Calling" },
                  { key: "allowVoiceCallsEmailsTexts", label: "Allow Voice Calls, Emails & Texts" }
                ].map((feature) => (
