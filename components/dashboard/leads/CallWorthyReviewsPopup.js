                                            ...
                                            importantCalls?.length > 0 ?
                                                <div className='w-full flex flex-row items-start justify-between'>
                                                    ...
                                                    <div className='w-4/12 px-3 flex flex-col'>
                                                        {
                                                            importantCalls?.map((item, index) => (
                                                                <button key={index} onClick={() => {
                                                                    setSelectedCall(item)
                                                                }}
                                                                    className='w-full p-3 flex flex-col gap-2 border-[2px] rounded-lg mt-5' style={{ borderColor: selectedCall.id === item.id ? "#7902df" : '' }}
                                                                >
                                                                    <div className='w-full flex flex-row justify-between items-center'>
                                                                        <div className='flex flex-col gap-2 items-start'>
                                                                            <div className='flex flex-row gap-2 items-center'>
                                                                                <div className='h-[27px] w-[27px] items-center justify-center pt-[2px] rounded-full bg-black' style={{ fontSize: 15, fontWeight: '500', color: '#fff' }}>
                                                                                    {item.firstName[0]}
                                                                                </div>
                                                                                <div style={{ fontSize: 15, fontWeight: '500' }}>
                                                                                    {item.firstName}
                                                                        ...
                                                                        <div className='flex flex-col gap-2 items-end'>
                                                                            <img src='/svgIcons/fireIcon.png'
                                                                                style={{ height: 17, width: 17 }}
                                                                            />
                                                                            <div className='flex flex-row gap-2 items-center'>
                                                                                <Image src={"/agentXOrb.gif"} height={23} width={23} alt='gif' />
                                                                                <div style={{ fontSize: 13, fontWeight: '600', color: '#7902df', textDecorationLine: 'underline', marginRight: 30 }}>
                                                                                    {`Ann's ai`}
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div className='w-full flex flex-row justify-between items-center'>
                                                                        <Image src={"/assets/manIcon.png"} height={23} width={23} alt='*' />
                                                    ...
                                                    <div className='w-8/12 flex flex-col'>
                                                        ...
                                                        <div className="w-full flex flex-col items-center h-full" >
                                                            ...
                                                            {
                                                                selectedCall && (
                                                                    <div className="w-full h-[80vh]" style={{ overflow: 'auto', scrollbarWidth: 'none', }}>
                                                                        <div>
                                                                            <div
                                                                                style={{
                                                                                    padding: 20,
