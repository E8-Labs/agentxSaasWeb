...
const CheckList = ({ userDetails, setWalkthroughWatched }) => {
  ...
  const getChecklist = () => {
    ...
    if (D) {
      ...
      const calendarUsageText =
        maxCalendars >= 1000
          ? 'Unlimited'
          : `${currentCalendars}/${maxCalendars}`

      setCheckList([
        {
          id: 1,
          label: 'Create your agent',
          status: T?.agentCreated,
          route: '/createagent',
        },
        {
          id: 2,
        ...
        },
        {
          id: 3,
          label: 'Intro video',
          status: LocalData?.user?.walkthroughWatched,
          route: '',
        },
        {
          id: 4,
            ...
            <div>
              {checkList?.map((item) => (
                <button
                  ...
                  disabled={
                    item.status === true && item.label !== 'Intro video'
                  }
                >
