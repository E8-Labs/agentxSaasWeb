...
const CheckList = ({ userDetails }) => {
  console.log(
    "User data recieved to check list is",
    userDetails?.user?.checkList?.checkList
  );
    ...
    setCheckList([
      {
        ...
        status: checklistData?.agentCreated,
        route: "/dashboard/myAgentX",
      },
      {
        id: 2,
        label: "Review your script",
        status: checklistData?.scriptReviewed,
        route: "/dashboard/myAgentX",
      },
      {
        id: 3,
        label: "Connect a calendar",
        status: checklistData?.calendarCreated,
        route: "/pipeline",
      },
      {
        id: 4,
        label: "Upload leads",
        status: checklistData?.leadCreated,
        route: "/dashboard/leads",
      },
      {
        id: 5,
        label: "Start Calling",
        status: checklistData?.callsCreated,
        route: "/dashboard/callLog",
      },
    ]);
  }, []);
