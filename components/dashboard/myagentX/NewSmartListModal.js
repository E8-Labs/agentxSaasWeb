...
const NewSmartListModal = ({ open, onClose, agentId, onSuccess, agentType, selectedUser }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Add userId for agency/admin scenarios (creating smartlist for subaccount agents)
      if (selectedUser) {
