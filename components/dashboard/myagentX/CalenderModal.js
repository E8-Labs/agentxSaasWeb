  ...
  const handlGoogleClick = () => {
    ...
    const oauthUrl =
      ...
      new URLSearchParams({
        ...
        response_type: "code",
        scope: PersistanceKeys.calendarScope,//"openid email profile https://www.googleapis.com/auth/calendar"
        access_type: "offline",
        prompt: "consent",
      }).toString();
  ...
  const handleAfterGoogleLogin = (data) => {
    try {
      ...
      const googleCalendar = {
        ...
        scope: PersistanceKeys.calendarScope,
