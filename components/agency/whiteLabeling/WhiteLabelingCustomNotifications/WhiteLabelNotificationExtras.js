export const StandardNotificationsList = [
  ...
  },
  {
    ...
    subjectDescription:
      "Hi [Name], Congratulations! You've just unlocked 30 additional minutes of AI talk time using your Agent Code: {Agent Code}. This bonus time will help you reach more prospects and close more deals. Make the most of this opportunity by uploading fresh leads and starting your calls right away. Best regards, The AssignX Team",
  ...
  },
  {
    ...
    subjectDescription:
      "Hi [Name], Great news! Your team, {Teamname}, has officially joined AssignX. What's next? You can now collaborate with your team members, share leads, and work together to maximize your success. Welcome aboard! Best, The AssignX Team",
    CTA: 'View Your Team Dashboard',
  },
  {
    id: 4,
    ...
    subjectDescription:
      "Hi [Name], Exciting news—your AI has identified a hot lead! Here are the details: Lead Name: {Leadname} This lead has shown high engagement and interest. Don't miss this opportunity to connect and convert. Best regards, The AssignX Team",
  ...
  },
  {
    ...
    subjectDescription:
      "Hi [Name], Exciting news! {Leadname} has just booked a meeting. This is a perfect opportunity to make progress toward closing the deal. Make sure you're prepared for the meeting and follow up promptly. Best regards, The AssignX Team",
  ...
  },
  {
    ...
    subjectDescription:
      "Hi [Name], We noticed an issue with your payment method, and your account is currently unable to process calls. To keep your AI up and running, please update your payment details immediately. Don't let this interrupt your success! Best regards, The AssignX Team",
  ...
  },
  {
    ...
    subjectDescription:
      "Hi [Name], We noticed your AI hasn't made any calls for 3 days. Is everything okay? Don't worry, we're here to help you get back on track. Join our live webinar to learn best practices and get your AI calling again. Best regards, The AssignX Team",
...
export const TrialPeriodNotificationsList = [
  ...
  // Day 2: Exactly 24 hrs later. If they haven't added leads
  {
    ...
    appNotficationBody:
      "Didn't get through everything in the live training? We can help.",
  ...
  // Day 6: 48hrs later
  {
    ...
    appNotficationBody:
      'Only 1 day left to use your 30 minutes of AI talk time.',
  ...
  // Day 7:
  {
    ...
    appNotficationBody:
      'Final call! Your 30 minutes of AI talk time expire at midnight.',
    appNotficationCTA: 'Get Live Help',
  ...
  // When minutes auto renew
  {
    ...
    appNotficationBody:
      '(30/90/120/etc) Minutes Added. Keep calling opportunities!',
    appNotficationCTA: 'Manage Plan',
...
export const PostTrialPeriodNotificationsList = [
  // 1 Day Later: Social Proof
  {
    ...
    emailNotficationTitle:
      'Sarah from [Same City] closed 2 listings last week!',
    emailNotficationBody:
      "Hi [Name], It's a numbers game, and Sarah from [Same City] knows it. She closed 2 listings last week using AssignX.",
  ...
  // 3 Days Later: Competitive Edge
  {
    ...
    appNotficationBody:
      'Few agents in [Same City] use AI. Act before others join.',
    appNotficationCTA: '',
    emailNotficationTitle: '',
    emailNotficationBody: '',
    emailNotficationCTA: '',
  ...
  // 5 Days Later: FOMO Alert
  {
    ...
    appNotficationBody:
      '4 listings secured in [Same City] in the last 2 weeks.',
    appNotficationCTA: '',
    emailNotficationTitle: '4 listing appointments secured near you!',
    emailNotficationBody:
      'Hi [Name], In the last 2 weeks, 4 listing appointments have been secured around [Same City]. The market is active, and other agents are making moves.',
  ...
  // 14 Days Later: Exclusivity
  {
    ...
    emailNotficationBody:
      "Hi [Name], Right now, you're part of a select group of agents in [Same City] leveraging AI to secure more listings. Others are catching on, but you've got the advantage.",
  ...
  // 20 Days Later: Territory Update
  {
    ...
    emailNotficationBody:
      "Hi [Name], Exciting news—2 listing appointments were recently secured within a 20-mile radius of your territory. The market is moving fast, and now's your chance to capitalize.",
...
export const GamificationNotificationList = [
  ...
  // After 1K Calls
  {
    ...
    appNotficationBody:
      'Keep going—top 20% are booking 3+ listings this month!',
    appNotficationCTA: '',
    emailNotficationTitle: '',
    emailNotficationBody: '',
    emailNotficationCTA: '',
  ...
  // When User Is Inactive for 5 days
  {
    ...
    appNotficationBody:
      'Call 200 homeowners to see a 10x increase in hot leads.',
    appNotficationCTA: '',
  ...
  // After 2K Calls
  {
    ...
    appNotficationBody:
      'Keep it up—top 10% are booking 4+ listings this month!',
    appNotficationCTA: '',
    emailNotficationTitle: '',
    emailNotficationBody: '',
    emailNotficationCTA: '',
  ...
  // After 7 Appointments
  {
    ...
    appNotficationBody:
      "7 streak achieved—your competition doesn't stand a chance!",
    appNotficationCTA: '',
    emailNotficationTitle: '',
    emailNotficationBody: '',
    emailNotficationCTA: '',
  ...
  // Day 14 Feedback Request
  {
    ...
    appNotficationBody:
      'Share your experience so we can make AssignX better for you.',
