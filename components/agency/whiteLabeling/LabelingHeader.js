...
const LabelingHeader = ({
    ...
    return (
        ...
        >
            <Image src={img} alt="brandConfig" width={52} height={52} className="mb-2" />
            <div className="text-white" style={styles.semiBoldHeading}>{title}</div>
            <div className="text-white" style={styles.smallRegular}>{description}</div>
        </div>
    )
}
