...
export default function AddXBarPlan({ open, handleClose, onPlanCreated, agencyPlanCost }) {
    ...
    return (
        <Modal open={open} onClose={() => { handleClose("") }}>
            ...
            <Box
                className="bg-white rounded-xl max-w-[80%] w-[95%] h-[90vh] border-none shadow-lg absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col">
