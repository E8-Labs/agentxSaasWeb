                ...
                />
                {
                    initialLoader ? (
                        ...
                        <div className="w-full border rounded-xl p-4 rounded-lg border rounded-xl">
                            <div style={{ fontWeight: "600", fontSize: "22px", color: "#000000" }}>Notifications</div>
                                    ...
                                    )}
                                    {
                                        addSuportWebCalendar && (
                                            <div className="flex flex-row items-center justify-between gap-2 mt-2">
                                                ...
                                                <div className="border border-gray-200 rounded px-2 py-0 flex flex-row items-center w-[45%]">
                                                    <input
                                                        style={styles.inputs}
                                                        type="text"
                                                ...
                                                <div className="border border-gray-200 rounded px-2 py-0 flex flex-row items-center w-[45%]">
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            setSuportWebCalendar(value);
                                                            setTimeout(() => {
                                                                if (value && value.startsWith("http") && !validUrl) {
                                                ...
                                                </div>
                                                {
                                                    addSuportWebCalendarLoader ? (
                                                        ...
                                                        <button
                                                            className={`w-[10%] h-[40px] rounded-lg ${isInValidUrlSuportWebCalendar || !suportWebCalendar ? "bg-btngray text-black" : "bg-purple text-white"}`}
...
const styles = {
    ...
    inputs: {
        fontWeight: "400", fontSize: 14, color: "#000000"
    }
}
