...
const UPSell = () => {
  ...
  const [allowPerplexityEnrichment, setAllowPerplexityEnrichment] =
    useState(false)
  const [addPerplexityEnrichment, setAddPerplexityEnrichment] = useState(false)
  const [perplexityEnrichmentLoader, setPerplexityEnrichmentLoader] =
    useState(false)
  const [delPerplexityEnrichmentLoader, setDelPerplexityEnrichmentLoader] =
    useState(false)
  //agency data
  ...
  const checkPrice = (price, from) => {
    ...
    if (from === 'phonePrice') {
      ...
      if (price < 0.03) {
        setSnackBannerMsg(
          `Upsell Price cannot be less than $ ${(0.03).toFixed(2)}`,
        )
        setSnackBannerMsgType(SnackbarTypes.Warning)
      } else {
        setSnackBannerMsg(null)
      ...
      if (price < 0.05) {
        setSnackBannerMsg(
          `Upsell Price cannot be less than $ ${(0.05).toFixed(2)}`,
        )
        setSnackBannerMsgType(SnackbarTypes.Warning)
      } else {
        setSnackBannerMsg(null)
    ...
    >
      <div className="w-11/12 pt-4">
        ...
        <LabelingHeader
          ...
          description={
            'Add your upsell prices and generated additional streams of revenue. '
          }
        />
        {initialLoader ? (
          ...
          <div className="w-full border rounded-xl p-4 rounded-lg border rounded-xl mt-8">
            ...
            <div className="border-b">
              <div className="border rounded-lg p-4 w-full mt-4 mb-4 bg-[#D9D9D917]">
                <div className="flex flex-row items-center justify-between w-full">
                  <div>
                    <div style={styles.heading}>Phone Numbers</div>
                  ...
                  <div className="flex flex-row items-center gap-2">
                    {delPhoneLoader ? (
                      ...
                      <Switch
                        checked={
                          allowUpSellPhone || settingsData?.upsellPhoneNumber
                        }
                        onChange={(e) => {
                          ...
                          if (
                            addUpSellPhone === false &&
                            settingsData?.upsellPhoneNumber === false
                          ) {
                ...
                {settingsData?.phonePrice && (
                  <div className="w-full flex flex-col gap-2">
                    <div className="w-full flex flex-row items-center justify-between">
                      <div style={styles.subHeading}>
                        Your upsell price is $
                        {(settingsData?.phonePrice || 0).toFixed(2)}/mo for each
                        number
                      </div>
                      <button
            ...
            <div className="border-b">
              <div className="w-full mt-4 mb-4 bg-[#D9D9D917] border rounded-lg p-4">
                <div className="flex flex-row items-center justify-between w-full">
                  <div>
                    <div style={styles.heading}>DNC</div>
                    <div style={styles.subHeading}>
                ...
                {settingsData?.dncPrice && (
                  <div className="w-full flex flex-col gap-2">
                    <div className="w-full flex flex-row items-center justify-between">
                      <div style={styles.subHeading}>
                        Your upsell price is $
                        {settingsData?.dncPrice.toFixed(2)}
                      </div>
                      <button
                        className="flex flex-row items-center gap-2"
                        onClick={() => {
            ...
            <div className="border-b">
              <div className="border rounded-lg p-4 w-full mt-4 mb-4 bg-[#D9D9D917]">
                <div className="flex flex-row items-center justify-between w-full">
                  <div>
                    <div style={styles.heading}>Perplexity Enrichment</div>
                    <div style={styles.subHeading}>
                      Easily upsell Perplexity lead enrichment | Your cost =
                      $0.05
                    </div>
                  </div>
                  <div className="flex flex-row items-center gap-2">
                    {delPerplexityEnrichmentLoader ? (
                      ...
                      <Switch
                        checked={
                          allowPerplexityEnrichment ||
                          settingsData?.upsellEnrichment
                        }
                        onChange={(e) => {
                          const checked = e.target.checked
                          ...
                          if (
                            addPerplexityEnrichment === false &&
                            settingsData?.upsellEnrichment === false
                          ) {
                ...
                {settingsData?.enrichmentPrice && (
                  <div className="flex flex-col gap-2 w-full mt-2">
                    <div className="flex flex-row items-center justify-between w-full">
                      <div style={styles.subHeading}>
                        Your upsell price is $
                        {settingsData?.enrichmentPrice.toFixed(2)}/mo for each
                        enrichment
                      </div>
                      <button
                        className="flex flex-row items-center gap-2"
            ...
            <div>
              <div className="flex flex-row items-center justify-between border rounded-lg p-4 w-full mt-4 mb-4 bg-[#D9D9D917]">
                <div>
                  <div style={styles.heading}>Leads</div>
