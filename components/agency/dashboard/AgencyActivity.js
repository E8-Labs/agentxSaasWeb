  ...
  return loading ? (
    ...
    >
      ...
      >
        ...
        {/* Top Metrics */}
        <Card className="agency-activity-metric-card cursor-pointer flex flex-col items-start text-left border-none shadow-none rounded-none min-w-0 w-full bg-transparent text-black/80 gap-3 relative z-0">
