...
function AgencySubscriptions({ selectedAgency }) {
  ...
  const totalNewSubscriptions = subscriptionChartData.reduce(
    (total, monthData) => {
      return (
        total +
        (monthData.Trial || 0) +
  ...
  const cancellationsRateData = Object.keys(
  ...
  return analyticData?.totalSubscriptions ? (
    <div
          ...
          <div className="flex flex-col w-8/12">
            ...
            >
              ...
              <div className="flex w-full flex-row items-center gap-8 mt-5 overflow-x-auto">
                {Object.keys(analyticData?.planSubscriptionStats || {}).map(
                  (planName, index) => (
                    <div
                      key={planName}
              ...
              <div className="flex w-full">
                ...
                >
                  ...
                  {Object.keys(analyticData?.planSubscriptionStats || {})
                    .length > 0 ? (
                    Object.keys(analyticData?.planSubscriptionStats || {}).map(
                      (planName, index) => (
                        <Line
                    ...
                    <Line
                      ...
                      data={[
                        {
                          month: moment().subtract(1, 'month').format('MMM DD'),
                          fallback: 0,
                        },
              ...
              >
                <div className="w-full flex flex-col items-center px-5 border">
                  ...
                  {planChartData.length > 0 ? (
                    ...
                    <div className="mt-10">Not enough data available.</div>
                  )}
                </div>
              </div>
