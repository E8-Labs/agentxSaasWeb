            ...
            <Box className="bg-white rounded-xl w-4/12 h-[70vh] border-none outline-none shadow-lg absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-6">
                <div className="w-full flex flex-col items-center justify-between h-[100%]">
                    <div className='w-full h-[90%] overflow-auto scrollbar-hide'>
                        ...
                        <div className='mt-2' style={styles.inputs}>Select SubAccount Status</div>
                            ...
                            <FormControl sx={{}} className="w-full h-[50px]">
                                <Select
                                    ...
                                    renderValue={(selected) => {
                                        if (!selected) {
                                            return <div style={{ color: "#aaa" }}>Select SubAccount Status</div>;
                                        }
                                        const accountStatus = subAccountStatus.find((p) => p.value === selected);
                        ...
                        <div className='mt-2' style={styles.inputs}>Select Plan</div>
                        <div className="w-full mt-2">
                            <FormControl sx={{}} className="w-full h-[50px]">
                                <Select
                                    value={selectPlanId}
                                    ...
                                    renderValue={(selected) => {
                                        ...
                                        const selectedPlan = plansList.find((p) => p.id === selected);
                                ...
                                >
                                    ...
                                    {plansList?.slice().reverse().map((item, index) => {
                                        return (
                                            <MenuItem
                                                className="w-full"
                                                value={item.id}
                    ...
                    <div className='w-full h-[10%]'>
                        {
                            initialLoader ? (
                                ...
                                <button className="w-full h-[50px] rounded-lg bg-purple text-white" style={{ fontSize: "15px", fontWeight: "500" }}
                                    onClick={() => {
                                        const filterData = {
                                            minSpent: minSpent,
                                            maxSpent: maxSpent,
