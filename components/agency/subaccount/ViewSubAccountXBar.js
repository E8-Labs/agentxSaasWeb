...
const ViewSubAccountXBar = ({
    ...
    const handleUpdateAgencyXBarPlans = async () => {
        try {
            ...
            if (response) {
                console.log("Response of update agency subaccount XBar plans api is", response.data);
                            ...
                            <div className="h-[53vh] overflow-auto">
                                {agencyXBarPlans.map((item, index) => (
                                    <button
                                        ...
                                        onClick={(e) => { handleToggleXBarClick(item.id); }}
                                    >
                                        {item.hasTrial && (
                                            ...
                                            style={{
                                                ...
                                                border:
                                                    selectedXBarPlans.includes(item.id)
                                                        ? "2px solid #7902DF"
                                                        : "1px solid #15151520",
                                                backgroundColor: item.id === selectedUser?.xbarPlan?.id ? "#402FFF05" : "",
                                            }}
                                        >
                                            <div
