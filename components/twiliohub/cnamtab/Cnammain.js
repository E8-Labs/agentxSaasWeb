        ...
        <div className="w-full flex flex-col items-center justify-between">
          ...
          <div className="w-full overflow-auto scrollbar scrollbar-track-transparent scrollbar-thin scrollbar-thumb-purple pb-2 px-2">
            ...
            <div className="mt-2" style={styles.normalTxt}>
              {`This name will show on your customers phone when you call them. You can display upto 15 characters. For example, if your business is called "AssignX", your CNAM name should also be something like AssignX or AssignX AI” — not something completely different.`}
            </div>
            ...
            <div className="mt-4 flex flex-row items-center w-full justify-between">
              <div style={styles.normalTxt}>CNAM display name*</div>
              <div style={styles.normalTxt}>{cnamName.length}/15</div>
            </div>
