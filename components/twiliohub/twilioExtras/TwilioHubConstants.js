...
export const customerType = [
  ...
  },
  {
    ...
    description:
      'My business uses twilio in a product that i sell to customers',
    type: 'reseller',
  },
  {
    id: 3,
...
export const registrationIdType = [
  ...
  {
    id: 6,
    title: 'Business Number - Generic fallback for some international regions',
  },
]
...
export const callingRules = [
  { id: 1, title: 'Collect explicit opt-in when required' },
  {
    id: 2,
    title:
      'State the name of business and phone number within the first 30 seconds',
  },
