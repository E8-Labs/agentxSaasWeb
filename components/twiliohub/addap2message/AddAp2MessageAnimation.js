...
const AddAp2MessageAnimation = ({ showModal, handleClose }) => {
  ...
  return (
    ...
    >
      <Box className="rounded-xl w-9/12 h-[85svh] shadow-lg bg-white border-none shadow-lg absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col p-6">
        <div className="h-[100%]">
          ...
          <AnimatePresence initial={false} custom={direction}>
            ...
            {currentIndex === 2 && (
              ...
              >
                <div className="h-[100%] w-full">Step_3</div>
              </motion.div>
            )}
