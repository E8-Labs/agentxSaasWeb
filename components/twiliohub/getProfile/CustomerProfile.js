  ...
  return (
    <div className="w-full">
      ...
      <div className="border rounded-lg w-full mt-2">
        ...
        />
        <div
          className={`flex flex-row items-center justify-between w-full ${showDetails && 'border-b-[2px]'}`}
        >
          <div className="w-full flex flex-row items-center justify-between px-4 py-2">
            <div className="flex flex-row items-center gap-2">
              <div style={styles.fontSemiBold}>Customer Profile</div>
              <div>
                <TwilioProfileToolTip
                  toolTip={
                    'This is basic information about your business or how you use Twilio — it helps carriers understand who you are.'
                  }
                />
              </div>
            </div>
