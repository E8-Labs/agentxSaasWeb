      ...
      >
        <div className="w-full flex flex-row items-center justify-between px-4 py-2">
          <div className="flex flex-row items-end gap-2">
            <div style={styles.fontSemiBold}>Branded Calling</div>
            <div>
              <TwilioProfileToolTip
                toolTip={
                  'Branded Calls let you show your business name, logo, and reason for calling right on the person’s phone — kind of like a caller ID upgrade.'
                }
              />
            </div>
          </div>
        ...
        <div className="w-full">
          <div className="w-full px-4">
            ...
            <div className="flex flex-row items-start mt-2">
              ...
              <div className="w-1/2">
                <div style={styles.mediumfontDarkClr}>Latif</div>
              </div>
            </div>
            <div className="flex flex-row items-center mt-2">
              <div className="w-1/2" style={styles.mediumfontLightClr}>
          ...
          <div className="w-full px-4 border-t-[2px]">
            ...
            <div className="flex flex-row items-center mt-2">
              ...
              <div className="w-1/2" style={styles.mediumfontDarkClr}>
                Lorem ipsum dolor sit amet consectetur. Malesuada pretium et sit
                nibh aliquet diam consequat nunc.Lorem ipsum dolor sit amet
                consectetur. Malesuada pretium et sit nibh aliquet diam
                consequat nunc.
              </div>
            </div>
          </div>
