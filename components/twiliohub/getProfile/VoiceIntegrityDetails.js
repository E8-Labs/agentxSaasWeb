        ...
        <div className="w-full flex flex-row items-center justify-between px-4 py-2">
          <div className="flex flex-row items-center gap-2">
            <Image
              ...
              width={18}
            />
            <div style={styles.fontSemiBold}>Voice Integrity Registration</div>
            <div>
              <TwilioProfileToolTip
                toolTip={
                  "Voice Integrity protects your phone number reputation. It ensures you're not accidentally doing things that might get your number blocked or flagged as spam."
                }
              />
            </div>
          </div>
