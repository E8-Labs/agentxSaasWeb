...
const StirDetails = ({
  ...
  return (
    <div className="border rounded-lg w-full">
        ...
        <div className="w-full flex flex-row items-center justify-between px-4 py-2">
          <div className="flex flex-row items-center gap-2">
            <Image
              ...
              width={21}
            />
            <div style={styles.fontSemiBold}>SHAKEN / STIR Calling</div>
            <div>
              <TwilioProfileToolTip
                toolTip={
                  'SHAKEN/STIR is a system that verifies your caller ID is real — not spoofed or fake. It helps your calls look more trustworthy and less like spam.'
                }
              />
            </div>
          </div>
      ...
      {stirStatus ? (
        <ShowRequestStatus status={stirStatus} twilioData={twilioHubData} />
      ) : (
        <LockDetailsView
