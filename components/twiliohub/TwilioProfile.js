      ...
      <div className="w-[80%] mt-16">
        {links.map((item) => {
          return (
            ...
            >
              <div
                className={`bg-[#ffffff30] h-[40px] w-[40px] rounded-full ${pathname === item.href ? 'border border-2 border-whte' : 'bordere-transparent outline-none'} flex flex-row items-center justify-center`}
              >
                <Image
                  alt="*"
                  src={item.img}
