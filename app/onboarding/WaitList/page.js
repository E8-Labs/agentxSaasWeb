                    ...
                    <div className='flex flex-col items-center h-[76vh]'>
                        ...
                        <div className='flex flex-col items-center px-4 w-full h-[90%]'>
                            ...
                            <div className='w-full flex flex-row items-center justify-center'>
                                ...
                                <img src={"/otherAssets/waitAvt.png"} style={{ width: "162px", height: "70px", resize: "contain" }} alt='*' />
                                {/* </div> */}
                            </div>
                            ...
                            <div className='mt-6 w-7/12 font-[400] overflow-auto' style={{ textAlign: "", fontSize: 15, scrollbarWidth: "none" }}>
                                <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: '1.6', margin: '2rem' }}>
                                    ...
                                    <h2 style={{ fontWeight: 'bold', marginTop: 40 }}>{`You’re Part of the Revolution.`}</h2>
                                    <p className='mt-1'>
                                    ...
                                    <h3 style={{ fontWeight: 'bold', marginTop: 30 }}>
                                    ...
                                    <p style={{ fontWeight: 'bold', marginTop: 30 }}>{`– Noah The Developer`}</p>
                                </div>
                            </div>
