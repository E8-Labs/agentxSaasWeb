...
import EmbedVapi from "@/app/embed/vapi/[id]/page";
...
function Page() {
    ...
    const formatName = (item) => {
        ...
        return ( <
            div > { agentName ? .slice(0, 1).toUpperCase(0) } { agentName ? .slice(1) } <
            /div>
        );
    };
...
></iframe>`;
    ...
    return ( <
        div className = "w-full flex flex-col items-center" > { /* Success snack bar */ } <
        div >
        <
        AgentSelectSnackMessage isVisible = { isVisibleSnack }
        hide = {
            () => {
        ...
        div >
        <
        AgentSelectSnackMessage isVisible = { isVisibleSnack2 }
        hide = {
            () => setIsVisibleSnack2(false) }
        ...
        <
        div className = "w-full flex flex-row justify-between items-center py-4 mt-2 px-10"
        style = {
            { borderBottomWidth: 2, borderBottomColor: "#00000010" } } >
        <
        div style = {
            { fontSize: 24, fontWeight: "600" } } > Agents < /div>
        ...
        <
        Image src = { "/assets/searchIcon.png" }
        height = { 24 }
        width = { 24 }
        alt = "*" /
        >
        ...
        style = {
            ...
            initialLoader ? ( <
                div className = "h-[70vh] flex flex-row justify-center gap-4" > { /*<CircularProgress size={45} />*/ } <
                MyAgentXLoader / >
                <
                /div>
            ) : ( <
                AgentsListPaginated oldAgentsList = { oldAgentsList }
        ...
        { /* code to add new agent */ } {
            agentsListSeparated.length > 0 && ( <
                Link className = "w-full py-6 flex justify-center items-center"
                href = "/createagent"
                style = {
                    {
                        // marginTop: 40,
        ...
        Modal open = { showRenameAgentPopup }
        onClose = {
            () => {
                setShowRenameAgentPopup(false);
            }
        ...
        <
        Box className = "w-10/12 sm:w-8/12 md:w-6/12 lg:w-4/12"
        sx = {
            {...styles.modalsStyle, backgroundColor: "white" } } >
        <
        div style = {
            { width: "100%" } } >
        <
        ...
        <
        Image src = { "/assets/crossIcon.png" }
        height = { 40 }
        width = { 40 }
        alt = "*" /
        >
        ...
        div className = "mt-4"
        style = {
            { fontWeight: "600", fontSize: 12, paddingBottom: 5 } } >
        Agent Name <
        /div> <
        input value = { renameAgent || "" }
...

        {
            renameAgentLoader ? ( <
                ...
                button className = "mt-4 outline-none"
                style = {
                    {
        ...
        <
        Box className = "lg:w-4/12 sm:w-10/12 w-full"
        sx = { styles.modalsStyle } >
        <
        div className = "flex flex-row justify-center w-full max-h-[80vh]" >
        <
        div className = "sm:w-full w-full px-10 py-8 h-full"
        style = {
            {
        ...
        <
        Image src = { "/otherAssets/testAiIcon.png" }
        height = { 19 }
        width = { 19 }
        alt = "icon" /
        >
...

        {
            !selectedAgent ? .phoneNumber && ( <
                ...
                <
                Image src = { "/assets/warningFill.png" }
                height = { 20 }
                width = { 20 }
                alt = "*" /
                >
        ...
        div style = {
            { marginTop: "8px" } } >
        <
        PhoneInput className = "border outline-none bg-white"
        country = { "us" }
        onlyCountries = {
            ["us", "sv", "pk"] }
        ...
        <
        div className = "max-h-[37vh] overflow-none"
        style = {
            { scrollbarWidth: "none" } } >
        {
            scriptKeys ? .map((key, index) => ( <
                ...
                <
                div className = "pt-5"
                style = { styles.headingStyle } > { key[0] ? .toUpperCase() } { key ? .slice(1) } <
                /div> <
        ...
        /div> <
        /div> <
        div className = "w-full mt-6 h-[15%]"
        style = {
            {} } > {
            testAIloader ? ( <
        ...
        { /* Can be use full to add shadow */ } { /* <div style={{ backgroundColor: "#ffffff", borderRadius: 7, padding: 10 }}> </div> */ } <
        /div> <
        /div> <
        /Box> <
        /Modal>
        ...
        <
        div className = "flex flex-row items-start justify-start mt-2 gap-4" > { /* Profile Image */ } <
        div className = "" >
        <
        button
        // className='mt-8'
        ...
        { /* Tooltip */ } <
        div className = "absolute left-0 top-full mt-1 w-max max-w-xs px-2 py-1 rounded-md bg-white
        shadow - md p - 2 text - black text - md font - [500] opacity - 0 group - hover: opacity - 100 pointer - events - none transition - opacity duration - 200 z - 50 "> { showDrawerSelectedAgent ? .name } <
        /div> <
        /div> <
        /div> <
        /button> <
        div className = "text-purple max-w-[140px]"
        style = {
        ...
        { /* {showDrawer?.phoneNumber} */ } { formatPhoneNumber(showDrawerSelectedAgent ? .phoneNumber) } <
        /div>
        ...
        div >
        <
        DuplicateConfirmationPopup open = { showDuplicateConfirmationPopup }
        handleClose = {
            () => setShowDuplicateConfirmationPopup(false) }
        handleDuplicate = { handleDuplicate }
        /> <
        div className = "flex flex-col gap-2  " > { /* GPT Button */ }

        {
            showModelLoader ? ( <
                ...
                button id = "gpt"
                onClick = {
                    (event) => setOpenGptManu(event.currentTarget) }
                style = {
                    {
                        display: "flex",
                        alignItems: "center",
                ...
                <
                Avatar src = { selectedGptManu ? .icon }
                sx = {
                    { width: 24, height: 24, marginRight: 1 } }
        ...
        <
        DuplicateButton handleDuplicate = {
            () => {
        ...
        { /* Code for agent info */ } {
            activeTab === "Agent Info" ? ( <
                ...
                <
                div style = {
                    { fontSize: 15, fontWeight: "500", color: "#666" } } >
                Language <
                /div>
                    ...
                    showLanguageLoader ? ( <
                        ...
                        } >
                        {
                            AgentLanguagesList.map((item, index) => {
                                return ( <
                                    MenuItem className = "flex flex-row items-center gap-2 bg-purple10 w-full"
                                    value = { item ? .title }
                                    key = { index }
                ...
                } >
                {
                    showVoiceExpressivenessLoader ? ( <
                        ...
                        FormControl >
                        <
                        Select value = { voiceExpressiveness }
                        onChange = {
                            async(event) => {
                ...
                } >
                {
                    showPhoneLoader ? ( <
                        ...
                        onClose = {
                            () => setOpenCalimNumDropDown(false) }
                        onOpen = {
                            () => setOpenCalimNumDropDown(true) }
                        className = "border-none rounded-2xl outline-none p-0 m-0"
                        displayEmpty value = { assignNumber }
                        ...
                        MenuItem style = { styles.dropdownMenu }
                ...
                div > {
                    showDrawerSelectedAgent ? .liveTransferNumber ? ( <
                        div > { showDrawerSelectedAgent ? .liveTransferNumber } <
                        /div>
                    ) : (
                        "-"
                    )
                ...
                div className = "w-full" >
                <
                EditPhoneNumberModal open = { showEditNumberPopup }
                close = {
                ...
                div >
                <
                div className = " lg:flex hidden  xl:w-[350px] lg:w-[350px]"
                style = {
                    {
                        // backgroundColor: "red"
                    }
                ...
                <
                UserCalender calendarDetails = { calendarDetails }
                ...
                <
                PiepelineAdnStage selectedAgent = { showDrawerSelectedAgent }
                ...
                <
                VoiceMailTab setMainAgentsList = { setMainAgentsList }
                agent = { showDrawerSelectedAgent }
                setShowDrawerSelectedAgent = { setShowDrawerSelectedAgent }
                /> <
                /div>
        ...
        <
        Box className = "w-10/12 sm:w-8/12 md:w-6/12 lg:w-4/12 p-8 rounded-[15px]"
        sx = {
            {...styles.modalsStyle, backgroundColor: "white" } } >
        <
        div style = {
        ...
        div className = "w-1/2" > {
            DelLoader ? ( <
                ...
                button className = "outline-none bg-red"
                style = {
                    {
                        color: "white",
                        height: "50px",
        ...
        { /*  Test comment */ } { /* Code for the confirmation of reassign button */ } <
        ...
        <
        Box className = "w-10/12 sm:w-8/12 md:w-6/12 lg:w-5/12 p-8 rounded-[15px]"
        sx = {
            {...styles.modalsStyle, backgroundColor: "white" } } >
        <
        div style = {
        ...
        <
        Image src = { "/assets/blackBgCross.png" }
        height = { 20 }
        width = { 20 }
        alt = "*" /
        >
        ...
        span className = "text-purple" > { formatPhoneNumber(showConfirmationModal ? .phoneNumber) } <
        /span>{" "}
        to { showDrawerSelectedAgent ? .name }. { /* {`{${showDrawer?.name}}`}. */ } <
        /p> <
        /div>
        ...
        div className = "flex flex-row items-center gap-4 mt-6" >
        <
        button className = "mt-4 outline-none w-1/2"
        style = {
            {
                color: "black",
                height: "50px",
        ...
        div className = "w-full" > {
            reassignLoader ? ( <
                ...
                button className = "mt-4 outline-none bg-purple w-full"
                style = {
                    {
                        color: "white",
                        height: "50px",
        ...
        <
        Box className = "w-10/12 h-[90%] sm:w-[760px] p-8 rounded-[15px]"
        sx = {
            {...styles.modalsStyle, backgroundColor: "white" } } >
        <
        div style = {
        ...
        { /* <div style={{ width: "20%" }} /> */ } <
        div style = {
            { fontWeight: "600", fontSize: 22 } } > { showScriptModal ? .name ? .slice(0, 1).toUpperCase(0) } { showScriptModal ? .name ? .slice(1) } <
        /div> <
        div style = {
            {
                direction: "row",
        ...
        style = {
            { height: "", fontWeight: "500", fontSize: 15 } } >
        <
...

        {
            showScript && ( <
                ...
                <
                div > You can use these variables: < /div> { /* <div className='flex flex-row items-center gap-2'> */ } <
                div style = {
                    { width: "fit-content" } }
                className = "text-purple flex flex-row gap-2" >
                { `{Address}` }, { `{Phone}` }, { `{Email}` }, { `{Kyc}` } { /* {`{First Name}`}, {`{Email}`}, */ } <
                /div>

                {
                    uniqueColumns ? .length > 0 && showMoreUniqueColumns ? ( <
                        ...
                        button className = "text-purple outline-none"
                        ...
                        div > {
                            uniqueColumns ? .length > 0 && ( <
                                button className = "text-purple flex flex-row items-center font-bold outline-none"
                                onClick = {
                                    () => {
                ...
                <
                VideoCard duration = { "13 min 56 sec" }
                width = "60"
                height = "40"
                horizontal = { false }
                playVideo = {
                ...
                div className = "mt-2"
                style = {
                    {...styles.paragraph, color: "#00000060" } } >
                Greeting <
                /div>

                <
                button className = "flex flex-row items-center gap-2 h-[43px] rounded-md bg-purple text-white px-4"
                style = {
                    {
                        fontWeight: "500",
                        fontSize: 15,
                ...
                div className = "mt-2" >
                <
                GreetingTagInput greetTag = { showScriptModal ? .prompt ? .greeting }
                kycsList = { kycsData }
                ...
                <
                PromptTagInput promptTag = { scriptTagInput }
                kycsList = { kycsData }
                from = { "Promt" }
                uniqueColumns = { uniqueColumns }
                tagValue = {
                ...
                <
                div className = "absolute bottom-2 right-7 left-7"
                style = {
                    {} } > {
                    showSaveChangesBtn && ( <
                        div className = "w-full" > {
                            UpdateAgentLoader ? ( <
                                ...
                                button className = "bg-purple w-full h-[50px] rounded-xl text-white"
                                style = {
            ...
            SeledtedScriptAdvanceSetting && ( <
...

                {
                    showObjectives && ( <
                        ...
                        <
                        div style = {
                            { marginTop: "40px", height: "80%" } } > { /* {showScriptModal?.prompt?.objective} */ }
                        ...
                        div className = "mt-4 w-full" >
                        <
                        PromptTagInput promptTag = { objective }
                        kycsList = { kycsData }
                        uniqueColumns = { uniqueColumns }
                            ...
                            showObjectionsSaveBtn && ( <
                                div > {
                                    UpdateAgentLoader ? ( <
                                        ...
                                        button className = "bg-purple w-full h-[50px] rounded-xl mb-4 text-white"
                                        style = {
                                            { fontWeight: "600", fontSize: 15 } }
                                        onClick = {
                                            async() => {
        ...
        <
        IntroVideoModal open = { introVideoModal }
        onClose = {
        ...
        <
        IntroVideoModal open = { introVideoModal2 }
        onClose = {
            () => setIntroVideoModal2(false) }
        ...
        {
            showClaimPopup && ( <
                ClaimNumber showClaimPopup = { showClaimPopup }
...
const Card = ({ name, value, icon, bgColor, iconColor }) => {
    return ( <
        div className = "flex flex-col items-start gap-2" > { /* Icon */ } <
        Image src = { icon }
        height = { 24 }
        color = { bgColor }
        width = { 24 }
        ...
        <
        div style = {
            { fontSize: 15, fontWeight: "500", color: "#000" } } > { name } <
        /div> <
        div style = {
            { fontSize: 20, fontWeight: "600", color: "#000" } } > { value } <
        /div> <
        /div>
    );
};
