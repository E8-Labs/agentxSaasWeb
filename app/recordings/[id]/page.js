        ...
        <div>
            {
                recordingLoader ? (
                    <div className='flex flex-col items-center justify-center h-screen w-full'>
                        ...
                        <div className='text-center mt-4' style={{ fontSize: screenWidth > 640 ? "22px" : "18px", fontWeight: "600", color: "#000000" }}>
                    ...
                    <div>
                        {
                            status === "not-loggedin" ? (
                                ...
                                <div style={styles.errorText}>Something went wrong. Please try again.</div>
                            ) :
                                (
                                    <div className='flex flex-col items-center justify-center h-screen w-full'>
                                        {
