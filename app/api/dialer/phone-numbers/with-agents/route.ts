...
/**
 * GET /api/dialer/phone-numbers/with-agents
 * List phone numbers with agent assignment information
 */
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('Error in GET /api/dialer/phone-numbers/with-agents:', error)
    return NextResponse.json(
