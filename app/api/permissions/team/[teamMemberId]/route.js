 ...
 * GET /api/permissions/team/[teamMemberId]?contextUserId=123
 */
export async function GET(req, { params }) {
  try {
    ...
    // Build backend URL
    let backendUrl = `${BASE_API_URL}api/permissions/team/${teamMemberId}`
    if (contextUserId) {
    ...
    console.error('Error in GET /api/permissions/team/[teamMemberId]:', error)
    return NextResponse.json(
      {
        status: false,
