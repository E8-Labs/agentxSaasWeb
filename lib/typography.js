...
// Agency Caption
export const TypographyCaption = createTypography('text-[12px] leading-[16px] font-normal', 'div')
TypographyCaption.displayName = 'TypographyCaption'

export const TypographyCaptionSemibold = createTypography('text-[12px] leading-[16px] font-semibold', 'div')
