...
/**
 * Server-side utility to read agency branding from cookies
 *
 * The branding cookie is set by the middleware (proxy.js) when:
...
export async function getServerBranding() {
  try {
    ...
    console.log('[getServerBranding] Error reading branding cookie:', e.message)
    return null
  }
}
