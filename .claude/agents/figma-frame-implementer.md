...
8. **ALWAYS use the ShadCN UI components** for consistent styling and layout
...
export function ComponentName({ className, ...props }) {
  return (
    <div
      className={cn('base-classes using-only tailwind-standards', className)}
    >
      {/* Implementation */}
    </div>
  )
...
```jsx
<div data-testid="usage-section" data-structure="parent" data-layout="vertical">
  <Card data-testid="usage-card" data-structure="container">
