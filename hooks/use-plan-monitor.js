...
export const usePlanMonitor = () => {
  ...
  // Handle plan upgrade
  const handlePlanUpgrade = useCallback((newPlanData) => {
  ...
  const handlePlanDowngrade = useCallback((newPlanData) => {
  ...
  const handlePlanCancellation = useCallback((cancellationData) => {
